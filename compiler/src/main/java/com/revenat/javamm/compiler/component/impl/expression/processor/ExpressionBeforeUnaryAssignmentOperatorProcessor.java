...
class ExpressionBeforeUnaryAssignmentOperatorProcessor extends UnaryAssignmentOperatorProcessor {

    protected ExpressionBeforeUnaryAssignmentOperatorProcessor(final Lexeme expression,
                                                               final Lexeme operator,
                                                               final List<Lexeme> result,
                                                               final SourceLine sourceLine) {
        super(expression, operator, result, sourceLine);
    }

    UnaryOperator getOperator() {
        return (UnaryOperator) next;
    }
    ...
    protected void processEntry() {
        ...
        result.add(new UnaryPostfixAssignmentExpression(operand, getOperator()));
    }
}
