 ...
 *
 */
public class SwitchOperationReader_Expected_Fail_IntegrationTest
        ...
        return named(Stream.of(
                ...
                arguments(
                        of(
                                ...
                                "}",
                                "}"
                        ), "Syntax error in 'module1' [Line: 3]: A constant expected between 'case' and ':'"),
                arguments(
                        of(
                                "switch ( a ) {",
                                "case 1 + 2 : {",
