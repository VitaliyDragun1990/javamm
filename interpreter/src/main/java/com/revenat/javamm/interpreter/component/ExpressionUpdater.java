...
public interface ExpressionUpdater<T extends UpdatableExpression> {
    ...
    /**
     * Returns class of a particular updatable expression {@code this} expression
     * updater can work with
     */
    Class<T> getExpressionClass();

    /**
     * Updates provided expression with updated value
     *
     * @param expression   expression to update
     * @param updatedValue new value to update expression with
     */
    void update(T expression, Object updatedValue);
}
