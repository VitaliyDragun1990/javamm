 ...
 *
 */
abstract class AbstractPredicateEqualsBinaryExpressionCalculator extends AbstractBinaryExpressionCalculator {

    protected AbstractPredicateEqualsBinaryExpressionCalculator(final BinaryOperator operator) {
        super(operator);
    }
