...
@DisplayName("a decrement '--' unary expression calculator")
class DecrementUnaryExpressionCalculatorTest extends AbstractUnaryExpressionCalculatorTest {

    @Test
    @Order(1)
    void shouldSupportUnaryDecrementOperator() {
        assertSupportOperator(UnaryOperator.DECREMENT);
    }
    ...
    void shouldReturnIncrementedValueByOneForNumbers() {
        ...
        assertThat(calculate(2.5), is(1.5));
    }
    ...
    protected UnaryExpressionCalculator createCalculatorUnderTest() {
        return new DecrementUnaryExpressionCalculator();
    }
}
